...
Pod::Spec.new do |s|
  s.name             = 'AXAListView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AXAListView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/AldoOS/AXAListView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'AldoOS' => 'harald.bregu@gmail.com' }
  s.source           = { :git => 'https://github.com/AldoOS/AXAListView.git', :tag => s.version.to_s }
